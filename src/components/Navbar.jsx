...
function Navbar() {
  ...
  return (
    <header
      ref={menuRef}
      className="flex border-b border-[#E5AB14] p-4 bg-slate-950 text-amber-100
    ...
    >
      ...
      <a href="/" className="flex justify-center">
        ...
        <div className="flex justify-center flex-col">
          <div
            className="text-[#E5AB14] flex gap-1 uppercase
                    flex-col
                    "
          >
            <span className="-mb-2 text-xs lg:text-xl lg:tracking-wide">
              Public Domain
            </span>
            <span className="font-bold tracking-widest text-xl lg:text-4xl">
              Library
            </span>
          </div>
          ...
          >
            {navLinks.map((navLink) => (
              <li key={navLink.label}>
                <NavLink to={navLink.path} className="hover:text-white">
                  {navLink.label}
                </NavLink>
              </li>
            ))}
