...
function FeaturedBooks() {
  return (
    <section className="text-center bg-orange-100 uppercase p-5">
                ...
                <ul className="flex justify-start lg:justify-center gap-5 py-5 px-4
                  overflow-x-auto gap-3 py-5 px-4 snap-x snap-mandatory scroll-smooth">
                    {books.map(book => (
                      <li key={book.fname+book.lname} 
                        className="
                          min-w-[280px] 
                          md:min-w-0 md:w-64 lg:w-72
                          snap-start
                        ">
                        <img src={book.image} className="shadow-lg bg-neutral-primary-soft mx-auto"/>
                        ...
                        <a href={book.url} target="_blank" rel="noopener noreferrer" className="block mt-1 py-2">Read</a>
                      </li>
                    ))}
                </ul>
